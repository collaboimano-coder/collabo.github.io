( function( $ ){
    ...
    var $backgrounds = $( "<ul class='sm-slider'></ul>" ),
        ...
        init : function( settings ) {
            ...
            $backgrounds.html(this.mkhtml( options.src )).prependTo("#slider");
